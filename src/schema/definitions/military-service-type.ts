...
export const militaryServiceType: DefinitionType = defineType({
  id: DefinitionTypeId.MilitaryServiceType,
  source: keyedBlocks("common/species_rights/military_service_types"),
  variants: [],
  localisation: [
