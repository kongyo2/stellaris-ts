...
export const popFactionNameFormat: DefinitionType = defineType({
  id: DefinitionTypeId.PopFactionNameFormat,
  source: taggedBlocks("common/random_names", "format", [], true, {
    rootKeyFilter: { mode: "include", values: ["pop_faction_name_format"] },
  }),
  variants: [],
  localisation: [],
  modifiers: [],
