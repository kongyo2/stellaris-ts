...
export const checkedNinterface: DefinitionType = defineType({
  id: DefinitionTypeId.CheckedNinterface,
  source: keyedBlocks("common/defines", true, { rootKeyFilter: { mode: "include", values: ["NInterface"] } }),
  variants: [],
  localisation: [],
  modifiers: [],
  entries: [],
