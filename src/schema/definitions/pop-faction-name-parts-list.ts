...
export const popFactionNamePartsList: DefinitionType = defineType({
  id: DefinitionTypeId.PopFactionNamePartsList,
  source: taggedBlocks("common/random_names", "key", [], true, {
    rootKeyFilter: { mode: "include", values: ["pop_faction_name_parts_list"] },
  }),
  variants: [],
  localisation: [],
  modifiers: [],
