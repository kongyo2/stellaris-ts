...
export const slaveryType: DefinitionType = defineType({
  id: DefinitionTypeId.SlaveryType,
  ...
  entries: [
    ...
    field("ai_can_colonize", literal(true), occurs.optional, {
      documentation: "otherwise, AI will not colonise with enslaved species",
    }),
