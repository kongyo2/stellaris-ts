...
export const migrationControl: DefinitionType = defineType({
  id: DefinitionTypeId.MigrationControl,
  source: keyedBlocks("common/species_rights/migration_controls"),
  variants: [],
  localisation: [
  ...
  entries: [
    ...
    field("can_migrate", literal(false), occurs.optional),
